...
const SETTING_COD_MEMO          = `Luna美媞晚安內衣，能夠幫助您打造完美胸型，解決您對各種內在美的煩惱。您貴重的商品，我們將以「台灣宅配通」進行最專業的配送服務，寄件者將顯示為「台灣娜珂黛肌」。<br>
...
const SETTING_CONV_MEMO         = `Luna美媞晚安內衣，能夠幫助您打造完美胸型，解決您對各種內在美的煩惱。<br>
...
const SETTING_MEMO_BOTTOM       = '如想更改訂單內容請聯繫客服，lineID搜尋：<a href="https://line.me/R/ti/p/%40779lezme" target="_blank">@779lezme</a>';
